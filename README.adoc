...
TIP: You can undo the effect of this command using cmd/ctrl+z

Example:
[source,clojure]
----
query ;; If you invoke the command with clojure.java.jdbc in your classpath

;; adds the following to your namespace :require form
[clojure.java.jdbc :as jdbc] ;; you'll then have to prefix your symbol manually e.g: jdbc/query
----

**TODO: Support custom alias (j/query resulting in [clojure.java.jdbc :as j])**
