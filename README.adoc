...
WARNING: This feature is currently only a proof of concept and will be reimplemented. It doesn't handle
rename of a symbol occuring multiple times on the same line, doesn't gracefully handle rename in open editors etc.
